...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/problemi/ois_ponti.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const ois_ponti_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "ois_ponti.html.vue"]]);
const data = JSON.parse('{"path":"/problemi/ois_ponti.html","title":"Ponti e isole","lang":"en-US","frontmatter":{},"headers":[],"git":{"updatedTime":1732922180000,"contributors":[{"name":"Giovanni","email":"112493877+ciao-gio@users.noreply.github.com","commits":1}]},"filePathRelative":"problemi/ois_ponti.md"}');
export {
