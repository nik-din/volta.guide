<template><div><h1 id="johnnie-walker" tabindex="-1"><a class="header-anchor" href="#johnnie-walker"><span>Johnnie Walker</span></a></h1>
<p>Link: <a href="https://training.olinfo.it/task/ois_walker" target="_blank" rel="noopener noreferrer">https://training.olinfo.it/task/ois_walker</a>
Fonte: OIS 2021 round 3</p>
<details>
  <summary>Categoria</summary>
<p>math</p>
</details>
<p>Problema di conteggi decente</p>
<details>
  <summary>Hint 1:</summary>
<p>Calcola la quantità ricorsivamente</p>
</details>
<details>
  <summary>Hint 2:</summary>
<p>In particolare ricorsivamente su K, e poi trova la formula chiusa. Attento agli inversi.</p>
</details>
<br></br> 
<details>
  <summary>Sketch di soluzione:</summary>
<p>Calcoliamo la soluzione ricorsivamente. In particolare f_i è la soluzione per k = i.<br>
Allora f_1 = 0, f_2 = n-1. f_3 sarà uguale a (n-1)^2 meno f_2, perché se arrivo a 1 appena prima della fine non posso rimanere nello stesso posto.<br>
Generalizzando f_i = (n-1)^(i-1)-f_{i-1}. Espandendo viene f_i = (n-1)^(i-1) - (n-1)^(i-2) + ... +- (n-1); l'ultimo segno dipende dalla parità di i. Facendo due casi dievrsi in base alla parità ed usando l'espansione di a^k+1 conclude.</p>
</details>
<br></br>
<details>
